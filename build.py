  ...
  <div class="wrap">
    ...
    <div class="roles stg">
      <div class="glass role-row">
        ...
        <a href="#apply" data-role="Testing &amp; Commissioning Engineer" class="btn btn-ghost">Apply</a>
      </div>
      <div class="glass role-row">
        <div>
        ...
        <a href="#apply" data-role="O&amp;M Engineer / Shift Engineer" class="btn btn-ghost">Apply</a>
      </div>
      <div class="glass role-row">
        <div>
        ...
        <a href="#apply" data-role="Protection &amp; Power System Studies Engineer" class="btn btn-ghost">Apply</a>
      </div>
      <div class="glass role-row">
        <div>
        ...
        <a href="#apply" data-role="Field Technician" class="btn btn-ghost">Apply</a>
      </div>
    </div>

    <div class="contact-grid stg" id="apply">
      <div class="glass info apply-intro">
        <p class="eyebrow">Apply</p>
        <h2>Send us your CV.</h2>
        <p>Pick the role, attach your CV, and it goes straight to our HR team at
          <a href="mailto:hr@slplpower.com">hr@slplpower.com</a>.</p>
        <p><b>Nothing listed that fits?</b> Choose &ldquo;General application&rdquo; and send your CV
          anyway. We keep good engineers on file and our project pipeline moves faster than this
          page does.</p>
      </div>

      <div class="glass form">
        <div class="f-row">
          <div class="fld"><label for="ap-nm">Name</label><input id="ap-nm" type="text" autocomplete="name" placeholder="Your name"></div>
          <div class="fld"><label for="ap-ph">Phone</label><input id="ap-ph" type="tel" autocomplete="tel" placeholder="+91"></div>
        </div>
        <div class="fld"><label for="ap-em">Email</label><input id="ap-em" type="email" autocomplete="email" placeholder="you@example.com"></div>
        <div class="fld"><label for="ap-role">Role</label>
          <select id="ap-role">
            <option>Testing &amp; Commissioning Engineer</option>
            <option>O&amp;M Engineer / Shift Engineer</option>
            <option>Protection &amp; Power System Studies Engineer</option>
        ...
        <div class="fld hp" aria-hidden="true"><label for="ap-wb">Website</label>
          <input id="ap-wb" type="text" tabindex="-1" autocomplete="off"></div>
        <button class="btn btn-solid" id="apply-send">Send application
        ...
        <p class="form-status" id="ap-fs" role="status" aria-live="polite"></p>
        <small>Goes straight to hr@slplpower.com with your CV attached.</small>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="contact-grid stg">
      ...
      <div class="glass form">
        ...
        <small>Goes straight to info@slplpower.com (careers questions to hr@slplpower.com). We reply within one working day.</small>
      </div>
    </div>
  </div>
</section>
